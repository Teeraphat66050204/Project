  ...
  return (
    <main className="min-h-screen bg-[#eef2f7] py-10 text-slate-900">
      <div className="mx-auto w-full max-w-md rounded-2xl bg-white p-6 shadow-lg shadow-slate-200/70">
        <h1 className="text-3xl font-black text-[#071c45]">Sign in</h1>
        <p className="mt-2 text-sm text-slate-500">Use your email and password account.</p>
        ...
        <p className="mt-4 text-center text-sm text-slate-600">
          No account yet?{" "}
          <a href={`/signup?next=${encodeURIComponent(nextPath)}`} className="font-semibold text-blue-600 hover:text-blue-700">
            Sign up
          </a>
        </p>
      </div>
